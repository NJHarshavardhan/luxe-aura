    ...
    <footer className="py-12 border-t border-border relative">
      ...
      <div className="container mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <motion.button
          ...
          className="w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center cursor-pointer shadow-[0_0_20px_hsl(268_100%_84.5%/0.2)]"

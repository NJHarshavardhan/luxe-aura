  ...
  useEffect(() => {
    ...
    class App {
      ...
      constructor(cont: HTMLElement, options: any) {
        ...
        this.renderer.setSize(cont.offsetWidth, cont.offsetHeight, false);
        this.renderer.setPixelRatio(window.devicePixelRatio);
        this.composer = new EffectComposer(this.renderer);
        cont.append(this.renderer.domElement);
        this.camera = new THREE.PerspectiveCamera(options.fov, cont.offsetWidth / cont.offsetHeight, 0.1, 10000);

...
const TextCursor: React.FC<TextCursorProps> = ({
  ...
  useEffect(() => {
    ...
    // Use a small delay or directly attach to document if we want it global,
    // but the component attaches to containerRef.
    // To make it global, we can attach to window if we are rendering at top level
